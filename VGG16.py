...
src_dir = f'datasets/y3.splitted.mini/'
...
# model = load_model(f"models/vgg16_model.h5")
...
face_label_filename = r"D:/1-projects.mlops/medface/models/face-labels.pickle"
with open(face_label_filename, 'wb') as f: pickle.dump(class_dictionary, f)
print('\nSaved labels.')

export_path = r"D:/1-projects.mlops/medface/models/my_model/1"

# Define the TensorFlow serving signature
