...
CREATE TABLE `medapp_medsessionperson` (
  ...
  `resnet50_label` varchar(200) NOT NULL,
  `resnet50_confidence` double NOT NULL,
  `senet50_label` varchar(200) NOT NULL,
  `senet50_confidence` double NOT NULL,
  `vgg16_label` varchar(200) NOT NULL,
  `vgg16_confidence` double NOT NULL,
...
-- Dump completed on 2023-10-16 14:55:18
